...
DESC STAGE SNOWFLAKE_KAFKA_CONNECTOR_LCC_J3PDXW_1780204643_STAGE_TOPIC_SURVEY_RESPONSES_ENRICHED;
LIST @SNOWFLAKE_KAFKA_CONNECTOR_LCC_J3PDXW_1780204643_STAGE_TOPIC_SURVEY_RESPONSES_ENRICHED;

DESC PIPE SNOWFLAKE_KAFKA_CONNECTOR_LCC_J3PDXW_1780204643_PIPE_TOPIC_SURVEY_RESPONSES_ENRICHED_0;
SELECT SYSTEM$PIPE_STATUS('SNOWFLAKE_KAFKA_CONNECTOR_LCC_J3PDXW_1780204643_PIPE_TOPIC_SURVEY_RESPONSES_ENRICHED_0');
